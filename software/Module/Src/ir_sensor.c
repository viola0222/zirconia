...
int16_t Sensor_GetValue(uint8_t dir) {
    switch (dir) {
        case 3:
            return adc_value[LED_FL_ON] - adc_value[LED_FL_OFF];
            break;
        case 2:
            return adc_value[LED_SL_ON] - adc_value[LED_SL_OFF];
            break;
        case 0:
            return adc_value[LED_SR_ON] - adc_value[LED_SR_OFF];
            break;
        case 1:
            return adc_value[LED_FR_ON] - adc_value[LED_FR_OFF];
            break;
        default:
            return -1;
            break;
...
void Sensor_DebugPrintf(void) {
    ...
    while (Communicate_Receice1byte() != _ESC) {
        printf("%5d (%4d - %3d), %5d (%4d - %3d), %5d (%4d - %3d), %5d (%4d - %3d)\r\n", adc_value[LED_FL_ON] - adc_value[LED_FL_OFF],
               adc_value[LED_FL_ON], adc_value[LED_FL_OFF], adc_value[LED_SL_ON] - adc_value[LED_SL_OFF], adc_value[LED_SL_ON], adc_value[LED_SL_OFF],
